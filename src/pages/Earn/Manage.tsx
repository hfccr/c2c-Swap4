...
import { JSBI, TokenAmount, ETHER } from '@udotcash/u-exchange-sdk'
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          When you withdraw, the contract will automagically claim C2C on your behalf!
        </TYPE.main>
          ...
          <DataRow style={{ marginBottom: '1rem' }}>
            {stakingInfo && stakingInfo.active && (
              <ButtonPrimary padding="8px" borderRadius="8px" width="160px" onClick={handleDepositClick}>
                {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? 'Deposit' : 'Deposit C2C LP Tokens'}
              </ButtonPrimary>
            )}
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : !stakingInfo?.active ? null : (
          <TYPE.main>{userLiquidityUnstaked.toSignificant(6)} C2C LP tokens available</TYPE.main>
        )}
      </PositionInfo>
    </PageWrapper>
  )
